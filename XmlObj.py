...
class RefactoriedList:
	def __init__(self):
		...
		self.refactoried_files.append(str('AlternateGroup1.cpp').lower())
		self.refactoried_files.append(str('AlternateGroup1.h').lower())
		...
		self.refactoried_files.append(str('DispatchList1.cpp').lower())
		self.refactoried_files.append(str('DispatchList1.h').lower())
		self.refactoried_files.append(str('DispatchListLotTransformSerialConfig1.cpp').lower())
		self.refactoried_files.append(str('DispatchListLotTransformSerialConfig1.h').lower())
		self.refactoried_files.append(str('DispatchListSerialRelation1.cpp').lower())
		self.refactoried_files.append(str('DispatchListSerialRelation1.h').lower())
		self.refactoried_files.append(str('DispatchListToProcess1.cpp').lower())
		self.refactoried_files.append(str('DispatchListToProcess1.h').lower())
		self.refactoried_files.append(str('DispatchListTransformLotRelation1.cpp').lower())
		self.refactoried_files.append(str('DispatchListTransformLotRelation1.h').lower())
		...
		self.refactoried_files.append(str('EqProcessingData1.cpp').lower())
		self.refactoried_files.append(str('EqProcessingData1.h').lower())
		self.refactoried_files.append(str('FabLinkLicense1.cpp').lower())
		self.refactoried_files.append(str('FabLinkLicense1.h').lower())
		self.refactoried_files.append(str('FabLinkLicenseEmpRelation1.cpp').lower())
		self.refactoried_files.append(str('FabLinkLicenseEmpRelation1.h').lower())
		self.refactoried_files.append(str('FabLinkLicenseOrgRelation1.cpp').lower())
		self.refactoried_files.append(str('FabLinkLicenseOrgRelation1.h').lower())
		self.refactoried_files.append(str('InputControl1.cpp').lower())
		self.refactoried_files.append(str('InputControl1.h').lower())
		self.refactoried_files.append(str('InputControlCarrierMaterialPosition1.cpp').lower())
		self.refactoried_files.append(str('InputControlCarrierMaterialPosition1.h').lower())
		...
		self.refactoried_files.append(str('InputControlMaterialRelation1.cpp').lower())
		self.refactoried_files.append(str('InputControlMaterialRelation1.h').lower())
		self.refactoried_files.append(str('InspectionItem1.cpp').lower())
		self.refactoried_files.append(str('InspectionItem1.h').lower())
		...
		self.refactoried_files.append(str('ManufactureProcessApprovalStatus1.cpp').lower())
		self.refactoried_files.append(str('ManufactureProcessApprovalStatus1.h').lower())
		...
		self.refactoried_files.append(str('ManufactureProcessTriggerEventRawData1.cpp').lower())
		self.refactoried_files.append(str('ManufactureProcessTriggerEventRawData1.h').lower())
		...
		self.refactoried_files.append(str('OutputControlCarrierMaterialPosition1.cpp').lower())
		self.refactoried_files.append(str('OutputControlCarrierMaterialPosition1.h').lower())
		...
		self.refactoried_files.append(str('OutputControlMaterialRelation1.cpp').lower())
		self.refactoried_files.append(str('OutputControlMaterialRelation1.h').lower())
		...
		self.refactoried_files.append(str('ProcessMaterialBomRelation1.cpp').lower())
		self.refactoried_files.append(str('ProcessMaterialBomRelation1.h').lower())
		self.refactoried_files.append(str('RawDataWipStatus1.cpp').lower())
		self.refactoried_files.append(str('RawDataWipStatus1.h').lower())
		self.refactoried_files.append(str('RawMaterial1.cpp').lower())
		self.refactoried_files.append(str('RawMaterial1.h').lower())
		self.refactoried_files.append(str('RawMaterialAlternate1.cpp').lower())
		self.refactoried_files.append(str('RawMaterialAlternate1.h').lower())
		...
		self.refactoried_files.append(str('ReworkHistory1.cpp').lower())
		self.refactoried_files.append(str('ReworkHistory1.h').lower())
		...
		self.refactoried_files.append(str('ShutdownReason1.cpp').lower())
		self.refactoried_files.append(str('ShutdownReason1.h').lower())
		...
		self.refactoried_files.append(str('SmWorkOrderType1.cpp').lower())
		self.refactoried_files.append(str('SmWorkOrderType1.h').lower())
		...
		self.refactoried_files.append(str('StationWorkingReportDeviceRelation1.cpp').lower())
		self.refactoried_files.append(str('StationWorkingReportDeviceRelation1.h').lower())
		...
		self.refactoried_files.append(str('ToolParameterItem1.cpp').lower())
		self.refactoried_files.append(str('ToolParameterItem1.h').lower())
		...
		self.refactoried_files.append(str('ToolParameterValue1.cpp').lower())
		self.refactoried_files.append(str('ToolParameterValue1.h').lower())
